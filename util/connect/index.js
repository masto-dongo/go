...
function makeMessages (intl, messager) {
  ...
  if (intl && messager) {
    ...
    for (name in messager) {
      Object.defineProperty(ℳ, name, { value: new String(messager[name].defaultMessage.test(/(?:\\\\|[^\\]|^){[^]+(?:\\\\|[^\\])}/) ? messager[name].id : intl.formatMessage(messager[name], messager[name].defaultValues)) });

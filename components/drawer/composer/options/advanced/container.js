...
`<ComposerAdvancedOptionsContainer>`
===================================

This container connects `<ComposerAdvancedOptions>` to the Redux store.
...
//  Our imports
import ComposerAdvancedOptions from '.';
...
export default connect(mapStateToProps, mapDispatchToProps)(ComposerAdvancedOptions);

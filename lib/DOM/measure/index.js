...
//  This trinary value is `true` if we're borked, `false` if we're
//  not, and `null` if we don't know.
let borked = null;

//  The first time this runs, we learn if we're borked.
export default function DOMMeasure (entry) {
